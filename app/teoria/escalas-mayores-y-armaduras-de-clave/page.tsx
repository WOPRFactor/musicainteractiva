...
const subtemas = [
  { name: 'Semitonos y Tonos', anchor: '#semitonos' },
  { name: 'La Escala Mayor', anchor: '#escala-mayor' },
  { name: 'Armaduras de Clave Mayores', anchor: '#armaduras-mayores' },
  { name: 'Ejercicios Prácticos', anchor: '#ejercicios' },
];

export default function EscalasMayoresArmadurasClavePage() {
  return (
    <main className="w-full min-h-screen bg-white">
      ...
      <div className="max-w-3xl mx-auto py-10 px-4">
        <h1 className="text-4xl font-extrabold mb-8 text-purple-800 tracking-tight">Escalas Mayores y Armaduras de Clave</h1>
        <section id="semitonos" className="mb-12">
          <h2 className="text-2xl font-bold text-purple-700 mb-3 flex items-center gap-2">
            <span className="text-lg">●</span> Semitonos y Tonos
          </h2>
          <hr className="border-t-2 border-purple-200 mb-4" />
        </section>
        <section id="escala-mayor" className="mb-12">
          <h2 className="text-2xl font-bold text-purple-700 mb-3 flex items-center gap-2">
            <span className="text-lg">●</span> La Escala Mayor
          </h2>
          <hr className="border-t-2 border-purple-200 mb-4" />
        </section>
        <section id="armaduras-mayores" className="mb-12">
          <h2 className="text-2xl font-bold text-purple-700 mb-3 flex items-center gap-2">
            <span className="text-lg">●</span> Armaduras de Clave Mayores
          </h2>
          <hr className="border-t-2 border-purple-200 mb-4" />
        </section>
