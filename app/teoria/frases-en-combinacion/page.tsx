  ...
  return (
    <main className="w-full min-h-screen bg-white">
      ...
      <div className="max-w-3xl mx-auto py-10 px-4">
        <h1 className="text-4xl font-extrabold mb-8 text-purple-800 tracking-tight">Frases en Combinación</h1>
        <section id="introduccion" className="mb-12">
          <h2 className="text-2xl font-bold text-purple-700 mb-3 flex items-center gap-2">¿Qué son las frases en combinación?</h2>
