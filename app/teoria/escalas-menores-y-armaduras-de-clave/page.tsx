...
const subtemas = [
  { name: 'Escalas Menores', anchor: '#escalas-menores' },
  { name: 'Armaduras de Clave Menores', anchor: '#armaduras-menores' },
  { name: 'Nombres de los Grados de la Escala', anchor: '#grados' },
  { name: 'Ejercicios Prácticos', anchor: '#ejercicios' },
];

export default function EscalasMenoresArmadurasClavePage() {
  return (
    <main className="w-full min-h-screen bg-white">
      ...
      <div className="max-w-3xl mx-auto py-10 px-4">
        <h1 className="text-4xl font-extrabold mb-8 text-purple-800 tracking-tight">Escalas Menores y Armaduras de Clave</h1>
        <section id="escalas-menores" className="mb-12">
          <h2 className="text-2xl font-bold text-purple-700 mb-3 flex items-center gap-2">
            <span className="text-lg">●</span> Escalas Menores
          </h2>
          <hr className="border-t-2 border-purple-200 mb-4" />
        </section>
        <section id="armaduras-menores" className="mb-12">
          <h2 className="text-2xl font-bold text-purple-700 mb-3 flex items-center gap-2">
            <span className="text-lg">●</span> Armaduras de Clave Menores
          </h2>
          <hr className="border-t-2 border-purple-200 mb-4" />
        </section>
        <section id="grados" className="mb-12">
          <h2 className="text-2xl font-bold text-purple-700 mb-3 flex items-center gap-2">
            <span className="text-lg">●</span> Nombres de los Grados de la Escala
          </h2>
          <hr className="border-t-2 border-purple-200 mb-4" />
        </section>
